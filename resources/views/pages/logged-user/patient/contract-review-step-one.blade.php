<div class="review-step one @if($shown == 'one') active @endif">
    ...
    <div class="step-fields module padding-top-20">
        ...
        <div class="single-row fs-0">
            <label class="calibri-light inline-block light-gray-color fs-16 padding-right-15 margin-bottom-0">ID Number:</label>
            <input type="text" maxlength="20" name="patient-id-number" class="right-field calibri-regular fs-18 dark-color inline-block pencil-background"/>
        </div>
        <div class="single-row fs-0">
            <label class="calibri-light inline-block light-gray-color fs-16 padding-right-15 margin-bottom-0">Postal Address:</label>
            <input type="text" maxlength="100" name="postal-address" class="right-field calibri-regular fs-18 dark-color inline-block pencil-background"/>
        </div>
        <div class="single-row fs-0">
            <label class="calibri-light inline-block light-gray-color fs-16 padding-right-15 margin-bottom-0">Country:</label>
            ...
            @else
                <select class="inline-block fs-18 right-field" id="country" name="country">
        ...
        <div class="single-row fs-0">
            ...
            @if(empty($patient->dcn_address))
                <input type="text" maxlength="42" name="dcn_address" class="right-field calibri-regular fs-18 dark-color inline-block pencil-background"/>
            @else
                <div class="right-extra-field calibri-regular fs-18 dark-color inline-block">
        ...
        <div class="singatures-row fs-0">
            <div class="dentist-sign inline-block">
                <figure itemscope="" itemtype="http://schema.org/ImageObject">
                    <img src="/assets/uploads/{{$contract->dentist_sign}}" alt="Dentist signature"/>
