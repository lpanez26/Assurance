...
@section("content")
    ...
    <section class="module section-ideal-use-cases background padding-top-200 padding-bottom-100">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <div class="lato-regular fs-30 padding-top-20 padding-bottom-50">Register for Free & Get Full Onboarding Support</div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 text-center">
                    <a href="javascript:void(0)" class="white-blue-green-btn min-width-220 show-login-signin">SIGN UP</a>
                </div>
            </div>
        </div>
    </section>
